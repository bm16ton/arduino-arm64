...
const uint16_t PixelCount = 64; // make sure to set this to the number of pixels in your strip
const uint8_t PixelPin = PB10;  // make sure to set this to the correct pin, ignored for Esp8266
